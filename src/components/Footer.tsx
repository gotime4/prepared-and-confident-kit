        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="mt-2 text-sm text-gray-500 max-w-md">
              ...
              self-sufficient, and confident in any situation.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              <li>
                <Link to="/kit" className="text-sm text-gray-500 hover:text-gray-900">
                  72-Hour Kit Guide
                </Link>
              </li>
              <li>
                <Link to="/food" className="text-sm text-gray-500 hover:text-gray-900">
                  Food Storage
                </Link>
              </li>
              <li>
                <Link to="/water" className="text-sm text-gray-500 hover:text-gray-900">
                  Water Storage
                </Link>
              </li>
            </ul>
